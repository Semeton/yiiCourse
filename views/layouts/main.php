...
<body class="d-flex flex-column h-100">
    ...
    $navItem = [
            ...
            ['label' => 'Calculator', 'url' => ['/calculator/calculate']],
            ['label' => 'Dictionary', 'url' => ['/dictionary/index']],
            ['label' => 'Note Book', 'url' => ['/notebook/index']],
        ];
    ...
    <footer class="footer mt-auto py-3 text-muted">
        <div class="container">
            <p class="float-left">&copy; Bincom Dev Center yiiCourse <?= date('Y') ?></p>
